class Router {
    constructor() {
        ...
        this.pageScripts = {
            ...
            'port-config': 'pages/js/port-config.js',
    ...
    cleanupPageScripts(page) {
        ...
        switch(page) {
            ...
            case 'port-config':
                delete window.port_config_initialized;
                this.initializedPages.delete(page);
                if (typeof window.cleanupPortConfig === 'function') {
                    window.cleanupPortConfig();
                }
                break;
    ...
    initializePageScripts(page) {
        ...
        this.currentInitializationTimer = setTimeout(() => {
            ...
            switch(page) {
                ...
                case 'port-config':
                    if (window.PortConfig && typeof window.PortConfig.init === 'function') {
                        window.PortConfig.init();
                        this.initializedPages.add(page);
                        window.port_config_initialized = true;
                    } else {
                        console.warn('PortConfig.init function not found');
                    }
                    break;
